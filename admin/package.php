                ...
                ?>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="form-actions form-group">
                                    <strong class="card-title">Package Table</strong>
                                    <button class="btn btn-success btn-sm" onclick="window.location.href='addPackageForm.php'">Add Package</button>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM packages WHERE packageID REGEXP '^[0-9]+$'";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="updatePackage.php?packageID=<?php echo $row['packageID']; ?>"><i class="fa fa-pencil"></i></a>&nbsp&nbsp&nbsp&nbsp
                                                    <a href="deletePackage.php?packageID=<?php echo $row['packageID']; ?>" onclick="return confirmDelete();"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                            }   
                                    ...
                                    <?php
                                        ...
                                        // The SQL query to fetch all records from the users table
                                        $sqlCustom = "SELECT * FROM packages WHERE packageID NOT REGEXP '^[0-9]+$'";
                                        ...
                                        // Fetch each row from the result set
                                            while($row = mysqli_fetch_assoc($resultCustom)) {
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row["price"]; ?></td>
                                                <td>
                                                    <a href="updatePackage.php?packageID=<?php echo $row['packageID']; ?>"><i class="fa fa-pencil"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                            }   
                    ...
                    <script>
                        function confirmDelete() {
                            return confirm("Are you sure you want to delete the package?");
                        }
                    </script>
