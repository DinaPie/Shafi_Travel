                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown active">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li class="active"><i class="fa fa-user"></i><a href="admin.php">Admin</a></li>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="deleteAdmin.php?id=<?php echo $row['id']; ?>" onclick="return confirmDelete();"><i class="fa fa-trash-o"></i></a></td>
                                            </tr>
                                        <?php
                                            }   
                                        }
