        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="my_booking.php" class="nav-item nav-link active">My Booking</a>
                    <a href="past_booking.php" class="nav-item nav-link">Past Booking</a>
                    <a href="wishlist.html" class="nav-item nav-link">Wishlists</a>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">My Booking</h6><br>
                <h1 class="mb-5"></h1>
            </div>
            <?php
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center p-4">
                            ...
                            <small style="color: #86B817;">Booking Confirmed</small>
                            <div class="d-flex justify-content-center mb-2">
                                <a href="#" class="btn btn-sm btn-primary px-3 border-end" >View</a>
                            </div>
                        </div>
                    </div>
                </div>
